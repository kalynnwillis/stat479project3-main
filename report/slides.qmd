...
- **Step 2 – Define IASA**
  - \(\text{IASA} = d_{\text{catch}} - d_{\text{throw}}\) for each target.
...
## Main Results: Separation Dynamics
...
- **Figure**:
  - ![](../figures/iasa_distribution.png){width=70%}

## Main Results: Drivers of Separation Change – Air Time

- **Air time**:
  - Longer throws are associated with **more negative IASA**.
  - Matches intuition: deeper balls give defenders more time to recover and close separation.
- **Diagnostics**:
  - Fitted vs. observed IASA cluster around the identity line; residuals are roughly centered and symmetric.

![](../figures/iasa_vs_airtime.png){width=70%}

## Main Results: Drivers of Separation Change – Initial Separation

- **Initial separation**:
  - Strong **regression to the mean**: very open throws tend to tighten; tightly contested throws sometimes drift toward neutral.
- **Interpretation**:
...
![](../figures/iasa_vs_dthrow.png){width=70%}

## Main Results: Markov Lift – League Dynamics
...
![](../figures/markov_transitions.png){width=65%}

## Main Results: Markov Lift – Top Receivers
...
![](../figures/markov_lift_bayes_intervals.png){width=70%}
